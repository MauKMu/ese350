...
#define REMOTE_NODE_ADDR16      ((uint16_t)0xAAA0)
// sending to AAA0
...
//                }    
        ...
        adjusted_x = corrected_a_x;
        adjusted_y = corrected_a_y;
        adjusted_z = corrected_a_z;
...
*/        
        if (cleared_for_sending || havent_sent_counter > 6) {
            send_data(xbee, remoteDevice16b, xbee_data, 1);
