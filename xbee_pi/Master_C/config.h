...
/* Connect P9 to RX, P10 to TX, P11 to RST, ans also power and ground */
...
#define RADIO_TX_D              p13
#define RADIO_RX_D              p14
...
#define RADIO_RESET             p11 /* TODO: specify your setup's GPIO (output) connected to the XBee module's reset pin */
#define RADIO_RESET_D           p15
